package dev.vality.exporter.businessmetrics.metrics.country;
...
@Component
public class PaymentsWithConversionStatusByCountryGaugeMetrics implements PaymentsGaugeMetrics {
