...
@Entity
@NamedNativeQuery(
        name = "getWithdrawalsCountMetricsByInterval",
        query = """
                with w4 as (with w3 as (with w2 as (with w1 as (select w.wallet_id,
                                                                ...
                                                                where w.event_created_at > :startPeriodDate and withdrawal_status in ('created')
                                                                  and w.current)
                                                    select w1.*,
                ...
                group by provider_id,
                         ...
                         withdrawal_status
                """,
        resultSetMapping = "WithdrawalsTransactionCountMetricDtoList")
@SqlResultSetMapping(
        name = "WithdrawalsTransactionCountMetricDtoList",
        classes = @ConstructorResult(
                targetClass = WithdrawalsTransactionCountMetricDto.class,
                columns = {
...
public class WithdrawalsTransactionCountMetricDto {
    ...
    public WithdrawalsTransactionCountMetricDto() {
    }

    public WithdrawalsTransactionCountMetricDto(String providerId, String providerName, String terminalId, String terminalName, String walletId, String walletName, String currencyCode, String status, String count) {
