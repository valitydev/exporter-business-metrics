...
(
    ...
    not
    null,
    destination_account_type_value
    varchar
    not
    null,
...
(
    ...
    not
    null,
    status_terminated_at
    timestamp,
    terms_id
    integer
    not
    null,
    legal_agreement_signed_at
    timestamp,
    legal_agreement_id
    varchar,
    legal_agreement_valid_until
    timestamp,
    report_act_schedule_id
    integer,
    report_act_signer_position
    varchar,
    report_act_signer_full_name
    varchar,
    report_act_signer_document
    dw
    .
    representative_document,
    report_act_signer_doc_power_of_attorney_signed_at
    timestamp,
    report_act_signer_doc_power_of_attorney_legal_agreement_id
    varchar,
    report_act_signer_doc_power_of_attorney_valid_until
    timestamp,
    contractor_id
    varchar,
    wtime
...
(
    ...
    .
    legal_entity,
    russian_legal_entity_registered_name
    varchar,
    russian_legal_entity_registered_number
    varchar,
    russian_legal_entity_inn
    varchar,
    russian_legal_entity_actual_address
    varchar,
    russian_legal_entity_post_address
    varchar,
    russian_legal_entity_representative_position
    varchar,
    russian_legal_entity_representative_full_name
    varchar,
    russian_legal_entity_representative_document
    varchar,
    russian_legal_entity_russian_bank_account
    varchar,
    russian_legal_entity_russian_bank_name
    varchar,
    russian_legal_entity_russian_bank_post_account
    varchar,
    russian_legal_entity_russian_bank_bik
    varchar,
    international_legal_entity_legal_name
    varchar,
    international_legal_entity_trading_name
    varchar,
    international_legal_entity_registered_address
    varchar,
    international_legal_entity_actual_address
    varchar,
    ...
    .
    private_entity,
    russian_private_entity_first_name
    varchar,
    russian_private_entity_second_name
    varchar,
    russian_private_entity_middle_name
    varchar,
    russian_private_entity_phone_number
    varchar,
    russian_private_entity_email
    varchar,
    wtime
    timestamp
    default
...
(
    ...
    bigserial
    constraint
    payment_payment_payer_info_pkey
    primary
    key,
    event_created_at
    timestamp
    ...
    bank_card_token
    varchar,
    bank_card_payment_system
    varchar,
    bank_card_bin
    varchar,
    bank_card_masked_pan
    varchar,
    bank_card_token_provider
    varchar,
    ...
    customer_binding_id
    varchar,
    customer_rec_payment_tool_id
    varchar,
    recurrent_parent_invoice_id
    varchar,
    recurrent_parent_payment_id
    varchar,
...
(
    ...
    calendar_ref_id
    integer,
    system_account_set_json
    varchar
    not
    null,
    default_contract_template_json
    varchar
    not
    null,
    default_wallet_contract_template_json
    varchar,
    providers_json
    varchar,
    inspector_json
...
(
    ...
    not
    null,
    payout_tool_info_russian_bank_account
    varchar,
    payout_tool_info_russian_bank_name
    varchar,
    payout_tool_info_russian_bank_post_account
    varchar,
    payout_tool_info_russian_bank_bik
    varchar,
    payout_tool_info_international_bank_account_holder
    varchar,
    payout_tool_info_international_bank_name
    varchar,
    payout_tool_info_international_bank_address
    varchar,
    payout_tool_info_international_bank_iban
    varchar,
    payout_tool_info_international_bank_bic
    varchar,
    payout_tool_info_international_bank_local_code
    varchar,
    payout_tool_info_international_bank_number
    varchar,
    payout_tool_info_international_bank_aba_rtn
    varchar,
    payout_tool_info_international_bank_country_code
    varchar,
    payout_tool_info_international_correspondent_bank_account
    varchar,
    payout_tool_info_international_correspondent_bank_name
    varchar,
    payout_tool_info_international_correspondent_bank_address
    varchar,
    payout_tool_info_international_correspondent_bank_bic
    varchar,
    payout_tool_info_international_correspondent_bank_iban
    varchar,
    payout_tool_info_international_correspondent_bank_number
    varchar,
    payout_tool_info_international_correspondent_bank_aba_rtn
    varchar,
    payout_tool_info_international_correspondent_bank_country_code
    varchar,
    payout_tool_info_wallet_info_wallet_id
    varchar
);
...
(
    ...
    not
    null,
    exchange_rate_rational_p
    bigint
    not
    null,
    exchange_rate_rational_q
    bigint
    not
    null,
    wtime
...
(
    ...
    bank_card_token_provider
    varchar,
    bank_card_issuer_country
    varchar,
    bank_card_bank_name
    varchar,
    bank_card_metadata_json
    varchar,
    bank_card_is_cvv_empty
    boolean,
    bank_card_exp_date_month
    integer,
    bank_card_exp_date_year
    integer,
    bank_card_cardholder_name
    varchar,
    payment_terminal_type
    ...
    crypto_currency
    varchar,
    mobile_commerce_operator_legacy
    dw
    .
    mobile_operator_type,
    mobile_commerce_phone_cc
    varchar,
    mobile_commerce_phone_ctn
    varchar,
    payment_session_id
    varchar,
    client_info_ip_address
    varchar,
    client_info_fingerprint
    varchar,
    rec_token
    varchar,
    route_provider_id
    ...
    varchar,
    session_payload_transaction_bound_trx_additional_info_rrn
    varchar,
    wtime
    timestamp
    default
...
(
    ...
    not
    null,
    destination_card_token
    varchar,
    destination_card_payment_system
    varchar,
    destination_card_bin
    varchar,
    destination_card_masked_pan
    varchar,
    amount
    bigint
    not
...
(
    ...
    dw
    .
    limit_config_time_range_type
    not
    null,
    time_range_type_calendar
    dw
    .
    limit_config_time_range_type_calendar,
    time_range_type_interval_amount
    bigint,
    limit_context_type
    dw
    .
    limit_config_limit_context_type
    not
    null,
    limit_type_turnover_metric
    dw
    .
    limit_config_limit_type_turnover_metric,
    limit_type_turnover_metric_amount_currency
    varchar,
    limit_scope
    dw
    .
    limit_config_limit_scope,
    limit_scope_types_json
    text,
    description
    varchar,
    ...
    dw
    .
    limit_config_operation_limit_behaviour,
    wtime
    timestamp
    default
    timezone(
